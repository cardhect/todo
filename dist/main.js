...
class Conductor {
	...
	grabFormData() {
		...
		let formatedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(dueDate), 'MMM d, Y');
		// console.log(dates);
...
let dates = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date('1998-4-9'), 'MMM d, Y');
console.log(dates);
