...
<<<<<<< HEAD
  ...
  AddEventListenerToListSubmit() {
    ...
    listSubmit.addEventListener('click', () => {
      ...
      const newList = listArray[listArrayLen - 1].title;
      const inputList = document.createElement('button');
      inputList.setAttribute('class', 'list-option');
  ...
  displayTodoAmount() {
    for (let i = 0; i < listArray.length; i++) {
      ...
      const defaultList = document.querySelector(
        '.header__list-title',
      ).textContent;
    ...
    todayTasksBtn.addEventListener('click', () => {
      ...
      for (let i = 0; i < listArray.length; i++) {
        ...
        for (let j = 0; j < listTodoLen; j++) {
          ...
          const dateResult = isToday(parsedTodoDate);
...
>>>>>>> 32d58051e3af4577801e9b55b1a990a136a217a6
}
dataCond.removeTodo();
export { Display };
<<<<<<< HEAD
